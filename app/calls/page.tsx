   ...
   <main className="min-h-screen bg-slate-50"> 
     ...
     <div className="bg-gradient-to-br from-emerald-950 via-slate-950 to-blue-950 text-white"> 
       <div className="max-w-7xl mx-auto px-6 py-12"> 
         ...
         <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-3">Live Call Dashboard</h1> 
         <p className="text-lg text-slate-300 max-w-2xl"> 
           Watch every conversation as it happens. Frustration scores, full transcripts, and instant escalation alerts — all in real-time. 
         </p> 
       </div> 
     </div> 
         ...
         <aside className="lg:sticky lg:top-24 lg:self-start lg:max-h-[calc(100vh-7rem)] lg:overflow-y-auto"> 
           <div className="rounded-2xl bg-white border border-slate-200 shadow-sm p-5"> 
             <div className="flex items-center justify-between mb-4"> 
               <div className="text-xs font-semibold uppercase tracking-wider text-slate-500">Recent Calls</div> 
                 ...
                 <div className="p-8"> 
                   ...
                   {currentScore >= 7 && ( 
                     <div className="p-3 rounded-lg bg-red-50 border border-red-200 text-sm text-red-700 flex items-center gap-2"> 
                       <span>⚠️</span> 
                       <span><strong>Escalation triggered</strong> — handed off to human agent</span> 
                     </div> 
                   )} 
